...
import { 
  ...
  BarChart3, Database, HardDrive, Sliders, Crop, ZoomIn, ZoomOut, Move, Film, FileJson
} from 'lucide-react';
 ...
 */
const resizeImage = (file, maxWidth = 2160) => {
...
const AdminView = ({ currentUser }) => {
  ...
  const [debugData, setDebugData] = useState({}); // Store raw data for inspection
